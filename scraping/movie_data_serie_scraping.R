...
#torrent url
url <-'https://www.torrent9.pl/torrents/series/'


#recuperer toutes les pages
all_url <- str_c(url,seq(51,2014,50),sep='')
...
#save
library(writexl)
write_xlsx(all_movie_data, path="F:\\PROJETS\\PROJETS_DATA\\Movie Space\\Data\\all_movie_serie_data.xlsx")
